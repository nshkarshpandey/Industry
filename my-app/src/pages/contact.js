...
import phone from "../assets/images/pho.png"
import mail from "../assets/images/mai.png"
...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        'template_eigujyz', // Replace with your EmailJS template ID
        templateParams,
  ...
  <div className="col-12 col-md-6 d-flex align-items-center mb-3 mb-md-0">
    ...
    >
      <img src={phone} alt="Phone" style={{ height: '24px', width: '24px' }} />
    </div>
    <div>
  ...
  <div className="col-12 col-md-6 d-flex align-items-center">
    ...
    >
      <img src={mail} alt="Email" style={{ height: '24px', width: '24px' }} />
    </div>
    <div>
