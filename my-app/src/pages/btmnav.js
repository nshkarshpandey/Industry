      ...
      >
        <div className="row text-center text-md-start">
          ...
          <div className="col-md-3">
            ...
            <li>
                <Link to="/home" className="text-decoration-none text-dark btm-txt">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-decoration-none text-dark btm-txt">
                  About
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-decoration-none text-dark btm-txt">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-decoration-none text-dark btm-txt">
                  Contact Us
                </Link>
              </li>
            </ul>
